...
{
    public class EmpresaTecnologiaService : IEmpresaTecnologiaService
    {
        private readonly IEmpresaTecnologiaRepository _repository;

        public EmpresaTecnologiaService(IEmpresaTecnologiaRepository repository)
        {
