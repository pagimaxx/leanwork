...
using System.IO;
using System;
using LeanWork.Api.Attributes;
using LeanWork.Infrastructure.CrossCutting.Utilities;
using LeanWork.Infrastructure.CrossCutting.IoC;

namespace LeanWork.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                var xmlMainPath = Path.Combine(AppContext.BaseDirectory, "LeanWork.Api.xml");
                var xmlAppPath = Path.Combine(AppContext.BaseDirectory, "LeanWork.AppService.xml");
