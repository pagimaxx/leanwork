...
/* harmony default export */ __webpack_exports__["default"] = ("<header class=\"app-header navbar\">\n  <h1 class=\"text-center\">Github Test</h1>\n</header>\n<div class=\"app-body\">\n  <div class=\"sidebar\">\n    <div class=\"sidebar\">\n      <nav class=\"sidebar-nav\">\n        <ul class=\"nav\">\n          <li class=\"nav-title\">Navegação</li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" href=\"list\">\n              Usuários Github\n            </a>\n          </li>\n        </ul>\n      </nav>\n    </div>\n  </div>\n  <main class=\"main\">\n    <router-outlet></router-outlet>\n  </main>\n</div>\n<footer class=\"app-footer\">\n  Made by Diego Oliveira to LeanWork\n</footer>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"row\">\n  <div class=\"col m-3\">\n    <div class=\"card\">\n      <div class=\"card-body\">\n        <h1>Lista de Usuários</h1>\n        <table class=\"table\">\n          <thead>\n            <tr>\n              <th>Id</th>\n              <th>Login</th>\n              <th style=\"width: 120px;\">Ações</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr *ngFor=\"let user of listUsers | slice:0:100\">\n              <td>{{user.id}}</td>\n              <td>{{user.login}}</td>\n              <td><a href=\"{{ 'detail/' + user.login }}\" class=\"btn btn-primary\">Detalhar</a></td>\n            </tr>\n          </tbody>\n        </table>\n      </div>\n    </div>\n\n  </div>\n</div>\n");
...
/* harmony import */ var _pages_detail_detail_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/detail/detail.component */ "./src/app/pages/detail/detail.component.ts");
...
const routes = [
    ...
    {
        path: 'detail/:login', component: _pages_detail_detail_component__WEBPACK_IMPORTED_MODULE_1__["DetailComponent"]
    }
];
...
/* harmony import */ var _pages_list_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/list/list.component */ "./src/app/pages/list/list.component.ts");
...
let DetailComponent = class DetailComponent {
    ...
    getUser() {
        this.githubService.getUser(this.login).subscribe((data) => {
            this.user = data;
        }, (error) => {
            this.erro = error;
        });
    ...
    getPublicReposByUsername() {
        this.githubService.getPublicReposByUsername(this.login).subscribe((data) => {
...
DetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./detail.component.css */ "./src/app/pages/detail/detail.component.css")).default]
    })
], DetailComponent);
...
ListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/list/list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./list.component.css */ "./src/app/pages/list/list.component.css")).default]
    })
], ListComponent);
...
let GithubService = class GithubService {
    ...
    getPublicReposByUsername(username) {
...
module.exports = __webpack_require__(/*! /Users/diegooliveira/Documents/Dev/Testes/LeanWork/github/src/main.ts */"./src/main.ts");
